                  ...
                  ListTile(
                    title: FilledButton.icon(
                      onPressed: _busyKey == 'addSticker'
                          ? null
                          : () => _addSticker(pack),
                      icon: const Icon(WaIcons.addImage),
